    ...
    <form:form modelAttribute="mymember" action="modify">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <font color="red">
                        <form:errors path="authList[0].auth" />
                    </font>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <font color="red">
                        <form:errors path="authList[1].auth" />
                    </font>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <font color="red">
                        <form:errors path="authList[2].auth" />
                    </font>
                </td>
            </tr>
        </table>
    </form:form>
    <div> <button type="submit" id="btnModify">Modify</button> <button type="submit"
            id="btnList">List</button> </div>
</main>
<%-- footer 영역 --%>
